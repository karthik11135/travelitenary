...
export const EditWaypoint = ({
  ...
  const [wpCost, setWpCost] = useState(wpDetails.wpCost);
  ...
  return (
    <div className="w-full mb-4 relative py-3 rounded-md  px-5 bg-gradient-to-r from-secondary to-primary">
      <div className="grid grid-cols-12">
        <div className="col-span-9">
          <div className=" mb-5 text-supreme">
            <p className="inline text-2xl text-white font-extrabold me-5">
              {index}
            </p>
            <input
